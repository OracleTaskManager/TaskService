...
public class SprintHoursReport {
    ...
    public static class TaskHoursDetail {
        ...
        public TaskHoursDetail(Long taskId, String taskTitle, Integer realHours, Integer estimatedHours){
            this.taskId = taskId;
    ...
    public SprintHoursReport(Long sprintId, String sprintName, Date startDate, Date endDate, Integer totalHours, List<TaskHoursDetail> taskDetails) {
