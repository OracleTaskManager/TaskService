...
public class UserTasksCompletedReport {
    private Long userId;
    ...
    public UserTasksCompletedReport() {}

    public UserTasksCompletedReport(Long userId, String userName, Long sprintId, String sprintName, Integer totalTasksCompleted, List<CompletedTask> completedTasks) {
        this.userId = userId;
