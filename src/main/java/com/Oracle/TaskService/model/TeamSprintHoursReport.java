...
public class TeamSprintHoursReport {
    ...
    public TeamSprintHoursReport(Long teamId, String teamName, Long sprintId, String sprintName, Integer totalHours, List<UserHoursDetail> userDetails) {
        this.teamId = teamId;
    ...
    public static class UserHoursDetail {
        ...
        public UserHoursDetail(Long userId, String userName, Integer totalHours, List<TaskDetail> tasks){
            this.userId = userId;
