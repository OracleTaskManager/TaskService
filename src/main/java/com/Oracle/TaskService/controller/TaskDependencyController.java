...
public class TaskDependencyController {
    ...
    @PostMapping("/")
    public ResponseEntity<?> saveTaskDependency(@RequestBody @Valid TaskDependencyRegister taskDependency) {
    ...
    public ResponseEntity<?> getTaskDependencyId(@PathVariable("task_dependency_id") Long taskDependencyId){
        return new ResponseEntity<>(taskDependencyService.getTaskDependency(taskDependencyId), HttpStatus.OK);
    }
